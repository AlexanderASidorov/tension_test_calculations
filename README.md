...
| 9     | Расчет коэффицинтов линейной регрессии с помощью полного факторного эксперимента. Часть 01.   |
| 10     | Расчет коэффицинтов линейной регрессии с помощью полного факторного эксперимента. Часть 02.   |
| 11     | Подготовка данных для машинного обучения (основы работы с библиотекой Pandas). Библиотека Scikit-learn (использование классов LinearRegression и MLPRegressor).   |
